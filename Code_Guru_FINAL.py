...
digit_minus.grid(row=3, column=4)

#add * button
digit_multiply = tk.Button(root, text="*", command= lambda: add_to_calculation("*"), width= 5, font=("Arial", 16))
digit_multiply.grid(row=4, column=4)

#add / button
digit_divide = tk.Button(root, text="/", command= lambda: add_to_calculation("/"), width= 5, font=("Arial", 16))
digit_divide.grid(row=5, column=4)

#add = button
digit_equals = tk.Button(root, text="=", command= evaluate_calculation, width= 5, font=("Arial", 16))
digit_equals.grid(row=5, column=3)

#add CLEAR button
digit_clear = tk.Button(root, text="C", command= clear_field, width= 5, font=("Arial", 16))
digit_clear.grid(row=5, column=1)
